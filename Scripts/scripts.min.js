	...
	n("html").removeClass("no-js"),
		n("header a").click(function (e) {
			if (!n(this).hasClass("no-scroll")) {
				if (n(this).attr("href") === "#github") {
					window.location.href = 'https://github.com/yourguyphil';
				} else if (n(this).attr("href") === "#linkedin") {
					window.location.href = 'https://www.linkedin.com/in/philips-nguyen';
				} else {
					e.preventDefault();
